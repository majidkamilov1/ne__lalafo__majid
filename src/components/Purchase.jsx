...
const Purchase = ({ setorderState, setSuccess }) => {
  ...
  return (
    <div className="fixed z-10  bg-[#24253cba] px-4 top-0 left-0 w-full  h-[100vh]">
      <div className="border border-[#e53854] bg-[#24253c] max-w-[400px]  mt-[100px] p-4  mx-auto rounded-[24px] flex flex-col relative">
          ...
          <div>
            <div className={`${stayleIput} relative`}>
              ...
              <input
                ...
                type="email"
                placeholder="Email"
                className="flex-1 font-semibold bg-[#24253c] text-[#b2b4bc] placeholder:text-[#b2b4bc]"
              />
            </div>
        ...
        {loading.payload && (
          <div
            ...
            className="bg-[#24253cad] rounded-[24px] absolute top-0 left-0 w-full h-full flex justify-center items-center"
          >
            <img
              className="w-[100px]"
