  ...
  return (
    <div className="diiiv relative flex-1">
      ...
      {!data?.results?.length && !loading && (
        <h1 className="flex mt-[50px] sm:text-4xl text-2xl text-[#e53854] text-center justify-center">
          нет товваров
        </h1>
      )}
      {loading ? (
        ...
        <div className="flex pt-[10px] justify-center">
          {next !== null && (
            <button
              ...
              className="border border-[#e53854] px-5 py-2 rounded-[20px] text-[#b2b4bc]"
            >
              пакозать ешё
            </button>
          )}
