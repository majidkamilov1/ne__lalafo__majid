...
const Saindbar = ({ ActiveBar, setActiveBar }) => {
  ...
  return (
    <div
      ...
      } z-10  bg-[#24253c] flex flex-col w-[250px] rounded-tr-[30px] rounded-br-[30px] lg:rounded-[30px] p-2 border border-[#e53854]`}
    >
      <span
      ...
      <h3 className="text-[30px] font-medium text-[#e53854]">Филтрация</h3>

      <ul className="w-[100%] flex-col pt-[15px] pb-[5px] flex gap-3">
        <li
          className={`border ${
            Active == 0 && "e1253"
          }  cursor-pointer rounded-[20px]  border-[#e53854] py-2 px-4 font-medium text-[#b2b4bc] `}
          key={0}
          onClick={() => {
            setActive(0);
            filterCategory("");
      ...
      <div className="clous pl-2 py-2 cursor-pointer  relative">
        <div className="flex items-center text-[#e53854]">
        ...
        <div
          className={`${
            activeSelect == "-price" && "text-[#e53854]"
          } hover:text-[#e53854]  text-[#b2b4bc] pl-3 font-medium`}
      ...
      <button
        onClick={all}
        className="w-full border border-[#e53854] py-[10px] mb-[6px] rounded-[20px]
        text-[#b2b4bc]
        font-medium
        "
      >
