    ...
    <>
      <header>
        <div className="max-w-[1200px] px-[10px] items-center flex justify-between mx-auto py-6 relative">
          <h3 className="text-5xl	 cursor-pointer font-medium	text-[#e53854] pb-[20px]">
            <Link to="/"> logo</Link>
          </h3>
          ...
          <nav>
            <ul className="flex gap-8 items-center">
              ...
              <li
                className={`search w-[500px]  cursor-pointer  gap-2 flex  p-2 border rounded-[30px]  border-[#e53854]
              ...
              <li>
                ...
                >
                  ...
                  {data.length > 0 && (
                    <span className="absolute top-[-5px] left-[90%]  text-[#e53854]  p-[2px]">
                      {data.length}
                    </span>
                  )}
                </Link>
                  ...
                  >
                    {user?.avatar ? (
                      <div className="w-[32px] ">
                        <img
                          className="w-full border-[#e53854] border rounded-full"
                          src={user?.avatar}
                          alt=""
                        />
                      </div>
