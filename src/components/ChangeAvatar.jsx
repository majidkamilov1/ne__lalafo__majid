    ...
    <div className="ChangeAvatar text-center  mb-2">
      <div className=" w-[70px]  mx-auto">
        {data?.avatar || avatar ? (
          avatar ? (
            <div
              className="rounded-full imgee border border-[#e53854] w-[70px] h-[70px]"
              style={{
      ...
      <label className={` relative custom-file-input`}>
        ...
        <span className="custom-file-input-label font-medium text-[#e53854] transition duration-150 ease-in-out hover:underline ">
