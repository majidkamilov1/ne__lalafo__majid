    ...
    <div className="flex-1">
      <div className="profile bg-[#1b1d31] w-full flex-1 px-[10px]">
        ...
        {popup ? (
          ...
          <div
            className="bg-[#24253c] relative  z-10 max-w-[500px] max-h-[700px] h-[60vh] px-7 py-5 mx-auto rounded-[24px] flex flex-col"
          >
            <span
              onClick={() => navigate(-1)}
            ...
            <h3 className="text-[#e53854] text-3xl font-semibold pb-5">
              Изменения пароль
            </h3>
            <div className="flex-1 flex flex-col gap-6 ">
              <div className="border-b border-[#e53854]">
                ...
                <input
                  ...
                  placeholder="пароль"
                  className="flex-1 pb-1 bg-[#24253c] w-full text-xl text-[#858892] font-normal placeholder:text-[#b2b4bc]"
                />
            ...
            <div className="button flex justify-between">
              <button
                ...
                className="border border-[#e53854] py-2 w-[170px] rounded-[24px] text-[#b2b4bc] font-medium"
              >
                изменить дынные
              </button>
              <button
