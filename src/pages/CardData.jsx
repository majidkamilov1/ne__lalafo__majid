      ...
      {loading ? (
        ...
        <div className="CardData boxes relative flex flex-1 pt-10  gap-[2.5%]  max-w-[1200px] mx-auto w-full px-[15px] ">
          ...
          <div
            ...
            className="img box1 rounded-[10px] border-[#e53854] border"
          ></div>

          <div className="imagesMin box2 bg-[#24253c] ">
          ...
          <div className="content box3 bg-[#24253c] border-[#e53854] border rounded-[10px] p-4 flex flex-col justify-end">
            <h1 className="w-full py-[10px] text-[#b2b4bc] font-medium pb-[20px] ">
              <span className="text-[#e53854]">Цена:</span> {oneData?.price}
              USD
            </h1>
            <button
              onClick={() => addTooCart()}
              className="border flex item-center justify-center gap-2 w-full py-[10px] border-[#e53854] rounded-[10px] text-[#b2b4bc] font-medium"
            >
          ...
          <div className="data box4 bg-[#24253c] relative  rounded-[10px] p-4 flex flex-col justify-start items-start border border-[#e53854]">
            <h4> {oneData?.name}</h4>
                ...
                <tbody className="w-full">
                  {oneData?.attributes?.map((item) => (
                    <tr key={item.id} className="w-full  flex ">
                      ...
                      <td className="w-[50%] text-[#fff]">{item.value}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <h5 className="text-[#ffffff]">
              <span className="text-[#e53854] text-[26px] pr-1">Описания:</span>{" "}
              {oneData?.description}
            </h5>

            <div className="tags mt-4">
              {oneData?.tags ? (
                <span className="tag text-[26px] items-end flex flex-wrap gap-x-2 text-[#e53854] font-medium">
                  tags:
