...
const label = "text-[#e53854] font-semibold text-[12px]";
const inputRadio = "w-full h-full opacity-0 absolute left-0 top-0";
const stayleIput =
  "w-full flex border-[#e53854] gap-2 border rounded-[30px] p-[10px]";
const Registration = () => {
  ...
  return (
    <>
      <div className="auth bg-[#1b1d31] w-full  h-[100vh] px-[10px]">
        <div className="bg-[#24253c] max-w-[400px] px-7 py-10 mx-auto rounded-[24px] flex flex-col relative">
          ...
          >
                ...
                <div className="custom-file-input-label flex flex-col items-center">
                  {avatar ? (
                    <div
                      ...
                      className="material-symbols-outlined w-[70px] border border-[#e53854] h-[70px] bg-center bg-no-repeat bg-cover rounded-full text-[#e53854]"
                    ></div>
                  ) : (
                    <span
                      to="/"
            ...
            <div>
              <div className="w-full flex  gap-4  relative ">
                <input
                  ...
                  placeholder="Имя"
                  className="border-[#e53854] w-[50%] border rounded-[30px] p-[10px] pl-4 flex-1 font-semibold text-[#b2b4bc] placeholder:text-[#b2b4bc]"
                />
                <input
            ...
            <button
              type="submit"
              className="bg-[#e53854]  rounded-[30px] text-white text-base font-semibold p-[10px] "
            >
              log in
            </button>
          </form>
      ...
      {loading?.payload ? (
        <div className="absolute bg-[#24253c7f] top-0 left-0 flex z-10 pt-10  justify-center items-start h-[100vh] w-[100vw] px-[15px] ">
          <img
