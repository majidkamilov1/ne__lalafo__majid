...
const label = "text-[#e53854] font-semibold";
const stayleIput =
  ...
  return (
    <>
      <div className="auth bg-[#1b1d31] w-full h-[100vh] px-[10px]">
        <div className="bg-[#24253c] max-w-[400px] max-h-[700px] h-[60vh] px-7 py-10 mx-auto rounded-[24px] flex flex-col relative">
          ...
          >
            ...
            <button
              type="submit"
              className="bg-[#e53854] mt-[20px]  rounded-[30px] text-[#b2b4bc] text-base font-semibold p-[10px] "
            >
              Войти
            </button>
          ...
          <div>
            <div className="flex justify-between pt-5">
              ...
              <span className="text-[#e53854]">
                <Link to={"/registration"}> Зарегаться</Link>
              </span>
            </div>
          </div>
      ...
      {loading?.payload ? (
        <div className="absolute bg-[#24253cf0] top-0 left-0 flex z-10 pt-10  justify-center items-start h-[100vh] w-[100vw] px-[15px] ">
          <img
