    ...
    <div className="profile bg-[#1b1d31] w-full flex-1 px-[10px]">
      ...
      {state ? (
        ...
        <div className="bg-[#24253c] relative  z-10 max-w-[500px]  h-[600px]  px-7 py-5 mx-auto rounded-[24px] flex flex-col">
          ...
          <span
            className="absolute cursor-pointer z-10 top-7 left-5 text-[#e53854] items-center flex"
            onClick={() => {
              setstate(true);
            }}
          >
          ...
          <div className=" w-[100px] mx-auto">
            {user?.avatar ? (
              <img
                className="rounded-full border border-[#e53854] w-full"
                src={user?.avatar}
                alt=""
              />
            ) : (
          ...
          <div className="button flex justify-between">
            <Link
              to="/profile/change"
              className="border text-center border-[#e53854] py-2 w-[170px] rounded-[24px] text-[#b2b4bc] font-medium"
            >
              изменить профиль
            </Link>
            <Link
